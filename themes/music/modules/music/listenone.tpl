	...
	<div class="box-infor-single box-info">
        ...
        <div class="infor-content">
            <div class="content-left">
                ...
                <a class="view-more  view-more-profile under show" rel="_profileContent">»&nbsp; Xem toàn bộ</a>
            </div>
   <span class="wrap">
    <a >
    ...
    <br />
    	<p class="msmall">{LANG.user_lyric}: {LYRIC_DATA.user}</p>
         ...
         <p>{LYRIC_DATA.content}</p>
             ...
             <a class="view-more under show view-more-lyric" style="display: inline;">»&nbsp; Xem toàn bộ</a>
                    </div>
    </div>
		</div>
		<!-- END: lyric -->
